...
<header>
    ...
    <div class="heroe">
        ...
        <h2>Create VA Proses</h2>
        <br>
        <br>
     <form class="group" method="post" action="<?= site_url('InquiryVA/status_va') ?>">
     <?= csrf_field() ?>
    <div class="mb-3">
        <label for="VA Number" class="form-label">VA Number</label>
        <input readonly type="text" class="form-control" name="vanum" id="virtualAccountNo" aria-describedby="virtualAccountNo" value="<?= $virtualAccountNo ?>"/>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" name="amount" id="amount" aria-describedby="totalAmount" value=" <?= $totalAmount ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="VA Name" class="form-label">VA Name</label>
        <input readonly type="text" class="form-control" id="virtualAccountName" aria-describedby="virtualAccountName" value="<?= $virtualAccountName ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" name="tXidVA" id="tXidVA" aria-describedby="tXidVA" value="<?= $tXidVA ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="TRX ID" class="form-label">TRX ID</label>
        <input readonly type="text" class="form-control" name="trxId" id="trxId" aria-describedby="trxId" value="<?= $trxId ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="bankCode" aria-describedby="bankCd" value="<?= $bankCode ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
