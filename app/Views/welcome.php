...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://docs.nicepay.co.id/" target="_blank">Docs Nicepay</a>
            </li>
            <li class="menu-item hidden"><a href="https://github.com/nicepay-dev" target="_blank">Plugin</a></li>
        </ul>
    </div>
        ...
        <div class="ui two centered stackable cards">
            ...
            <div class="blue card">
                <div class="content">
                    ...
                    <div class="description">
                        How-to Generate and Inquiry for Virtual Account.
                    </div>
                </div>
                <div class="extra content">
                    <div class="ui two buttons">
                        <a class="ui basic blue button" href="<?= site_url('/token') ?>">Virtual Account</a>
                    </div>
                </div>
            </div>
            ...
            <div class="green card">
                <div class="content">
                    ...
                    <div class="description">
                        How-to Generate, Inquiry, and Refund for Ewallet.
                    </div>
                </div>
                <div class="extra content">
                    <div class="ui two buttons">
                        <a class="ui basic green button" href="<?= site_url('/tokenEwallet') ?>">Ewallet</a>
                    </div>
                </div>
            </div>
