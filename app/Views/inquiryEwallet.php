...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Ewallet || BI SNAP</h1>

        <h2>Inquiry Proses</h2>
        <br>
        <br>
        <form class="group" method="post">
        <div class="mb-3">
        <label for="Response Code" class="form-label">Response Code</label>
        <input readonly type="text" class="form-control" id="respCode" aria-describedby="respCode" value="<?= $responseCode ?>"/>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="RespMessage" aria-describedby="respMessage" value="<?= $responseMessage ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="Reference No" class="form-label">Reference No</label>
        <input readonly type="text" class="form-control" name= "RefNo" id="RefNo" aria-describedby="RefNo" value="<?= $originalReferenceNo ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="Original Partner Reference No" class="form-label">Original Partner Reference No</label>
        <input readonly type="text" class="form-control" name ="oriPartnerRefNo" id="oriPartnerRefNo" aria-describedby="oriPartnerRefNo" value="<?= $originalPartnerReferenceNo ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="Latest transaction Status" class="form-label">Latest transaction Status</label>
        <input readonly type="text" class="form-control" id="latestTrx" aria-describedby="latestTrx" value="<?= $latestTransactionStatus ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    
    <div class="mb-3">
        <label for="Latest transaction Status Desc" class="form-label">Latest transaction Status Desc</label>
        <input readonly type="text" class="form-control" id="transStatus" aria-describedby="transStatus" value="<?= $transactionStatusDesc ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="amount" aria-describedby="amount" value="<?= $transAmount ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="goodsNm" aria-describedby="goodsNm" value="<?= $goodsNm ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="billingNm" aria-describedby="billingNm" value="<?= $billingNm ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    <div class="mb-3">
        <label for="Mitra" class="form-label">Mitra</label>
        <input readonly type="text" class="form-control" id="mitraCd" aria-describedby="mitraCd" value="<?= $mitraCd ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    <div class="mb-3">
        <label for="Phone" class="form-label">Phone</label>
        <input readonly type="text" class="form-control" id="billingPhone" aria-describedby="billingPhone" value="<?= $billingPhone ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

        <a href="<?php echo site_url().'';?>"><input type="button" value="back" class="btn btn-primary"/></a>
    </div>
    </form>
    </div>
