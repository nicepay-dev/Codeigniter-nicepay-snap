...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="https://codeigniter4.github.io/userguide/" target="_blank">Docs Nicepay</a>
            </li>
            <li class="menu-item hidden"><a href="https://forum.codeigniter.com/" target="_blank">Plugin</a></li>
        </ul>
    </div>

    <div class="heroe">
    <div class="content">
        <h1>NICEPAY -  BI SNAP </h1>
        
        <div class="ui divider"></div>
    <br>

            <form class="group" method="post" action="<?= site_url('CreateVA/generate_va') ?>">
            <div class="mb-3">
                <label for="accessToken" class="form-label">Akses Token</label>
                <input readonly type="text" class="form-control" id="accessToken" aria-describedby="accessToken" value="<?= $accessToken; ?>"/>
            ...
            <div class="mb-3">
                ...
                <input readonly type="text" class="form-control" id="responseMessage" aria-describedby="responseMessage" value="<?= $responseMessage; ?>"/>
                <span class="highlight"></span>
                <span class="bar"></span>
            </div>
            ...
            <div class="mb-3">
                ...
                <input readonly type="text" class="form-control" id="expiresIn" aria-describedby="expiresIn" value="<?= $expiresIn; ?>"/>
                <span class="highlight"></span>
                <span class="bar"></span>
            </div>
            <button type="submit" class="btn btn-primary" >Generate VA</button>
            </form>
