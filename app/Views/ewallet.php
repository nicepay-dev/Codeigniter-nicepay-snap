...
<header>
    ...
    <h2>Create Ewallet Proses</h2>
        <br>
        <br>
    <form class="group" method="post" action="<?= site_url('InquiryEwallet/status_ewallet') ?>">
    <div class="mb-3">
        <label for="Response Code" class="form-label">Response Code</label>
        <input readonly type="text" class="form-control" id="respCode" aria-describedby="respCode" value="<?= $responseData['responseCode'] ?>"/>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" id="RespMessage" aria-describedby="respMessage" value="<?= $responseData['responseMessage'] ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <div class="mb-3">
        ...
        <input readonly type="text" class="form-control" name= "RefNo" id="RefNo" aria-describedby="RefNo" value="<?= $responseData['referenceNo'] ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="Partner Ref No" class="form-label">Partner Ref No</label>
        <input readonly type="text" class="form-control" name ="partnerRefNo" id="partnerRefNo" aria-describedby="partnerRefNo" value="<?= $responseData['partnerReferenceNo'] ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

    <div class="mb-3">
        <label for="Web Direct Url" class="form-label">Web Direct Url</label>
        <input readonly type="text" class="form-control" id="webDirect" aria-describedby="webDirectUrl" value="<?= $responseData['webRedirectUrl'] ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    
    <div class="mb-3">
        <label for="Valid App Direct Url" class="form-label">App Direct Url</label>
        <input readonly type="text" class="form-control" id="AppDirect" aria-describedby="AppDirect" value="<?= $responseData['appRedirectUrl'] ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>
    ...
    <label for="amount" class="form-label"amount</label>
        <input readonly type="text" class="form-control" id="redirectToken" aria-describedby="redirectToken" value=""/>
        <span class="highlight"></span>
        <span class="bar"></span> -->
