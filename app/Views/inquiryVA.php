...
<header>
    ...
    <div class="heroe">
        ...
        <div class="mb-3">
            <label class="form-label">tXid VA</label>
            <input readonly type="text" class="form-control" name="tXidVA" id="tXidVA" value="<?= $tXidVA ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
        <div class="mb-3">
            <label class="form-label">Trx Id</label>
            <input readonly type="text" class="form-control" name="trxId" id="trxId" value="<?= $trxId ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
        <div class="mb-3">
            <label class="form-label">Virtual Account Name</label>
            <input readonly type="text" class="form-control" name="virtualAccountName" id="virtualAccountName" value="<?= $virtualAccountName ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
        ...
        <div class="mb-3">
            ...
            <input readonly type="text" class="form-control" name="virtualAccountNo" id="virtualAccountNo" value="<?= $virtualAccountNo ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
        ...
        <input readonly type="text" class="form-control" name="totalAmount" id="totalAmount" aria-describedby="totalAmount" value=" <?= $totalAmount ?>"/>
        <span class="highlight"></span>
        <span class="bar"></span>
    </div>

        <div class="mb-3">
            <label class="form-label">Transaction Status Desc</label>
            <input readonly type="text" class="form-control" name="transactionStatusDesc" id="transactionStatusDesc" aria-describedby="transactionStatusDesc" value=" <?= $transactionStatusDesc ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
        <div class="mb-3">
            <label class="form-label">Latest Transaction Status</label>
            <input readonly type="text" class="form-control" name="latestTransactionStatus" id="latestTransactionStatus" aria-describedby="latestTransactionStatus" value=" <?= $latestTransactionStatus ?>"/>
            <span class="highlight"></span>
            <span class="bar"></span>
        </div>
