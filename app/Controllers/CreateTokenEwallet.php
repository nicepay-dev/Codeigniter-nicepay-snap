...
class CreateTokenEwallet extends BaseController { 
    ...
    $session = session();
    $session->set("aksesToken", $responseData['accessToken']);
    echo "<br>";
      //print_r ($responseData['accessToken']);
    echo view('requestTokenEwallet',$data);
